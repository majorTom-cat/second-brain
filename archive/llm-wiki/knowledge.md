...
- `chats\INDEX.md`(세션 색인). 2026-06 신규 세션: 자료 드래그·드롭 업로드 버그(10cf2565), docker 재기동·프라이빗 질의·결재요청(03bf49fb), intellij 복구·위키 초기화 설계(bc5bec65), **아카이브 룸 사이드바 복구 + claude-cli(6번째 공급자) 추가·AVX 배포한계**(68cccbe2, 2026-06-16~17)
