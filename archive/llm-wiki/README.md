...
> 과거 프로젝트의 지식·아이디어·채팅 이력 보관소. `/archive llm-wiki` 가 생성/갱신한다.
...
| 채팅 원본 | 평문(chats/raw/) |
| 원본 용량 | 87.8M |
| 사내정보 | 2436건 (STRONG) → allow_internal 평문유지 ([SENSITIVE.md](chats/SENSITIVE.md)) |
| 마지막 인제스트 | 2026-06-21 16:15 |
| distill 후 새 세션 | 4 개 — knowledge.md 재정리 권장 |
