...
- **창작/인입**: [ingest-convergence](patterns/ingest-convergence.md)(문서→수렴/변경인입) · [design-ready-skin](patterns/design-ready-skin.md)(구조 먼저·비주얼은 토큰 1패스) · [redesign-greenfield-vs-inplace](patterns/redesign-greenfield-vs-inplace.md)(전면 리디자인=그린필드·점진 델타=인플레이스; 기존 코드 중력 — agora→intra)
